...
namespace UIMFLibrary
{
    public class DataReader : IDisposable
    {
        ...
        protected Dictionary<int, FrameParameters> m_frameParametersCache;
        protected GlobalParameters m_globalParameters;
        protected string m_uimfFilePath;
        ...
        /// <returns></returns>
        protected bool IsCalibrated(FrameType iMaxFrameTypeToExamine)
        {
