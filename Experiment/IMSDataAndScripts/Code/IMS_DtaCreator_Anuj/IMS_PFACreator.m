...
output_file_name = 'C:\SequestRunner\4pepdtas\AllDTAs.txt' ;
...
%          output_file_name = strcat(output_file_name, '.dta') ;
         ...
         fprintf(fout, '%d\t%d\t', parent_umc_data(parent_index, 8), parent_umc_data(parent_index,11)) ;
         fprintf(fout, '%d\t%d\n', parent_umc_data(parent_index, 4), parent_umc_data(parent_index,5)) ;
         ...
         for fragmentCounter =1:size(fragment_indices,2)
                ...
                %ICR2LS
                fprintf(fout, '%6.3f %6.3f %d\n', fragment_umc(:,12), fragment_umc(:,14),fragment_umc(:,11)) ;
